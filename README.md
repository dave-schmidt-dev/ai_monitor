...
- Live repaint now uses cursor-relative redraw (`cursor-up + clear-to-end`) to keep startup/countdown/update cycles in-place across terminals where absolute-home or alternate-screen sequences are unreliable.
